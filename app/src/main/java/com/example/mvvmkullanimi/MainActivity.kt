...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mainActivityNesnesi = this //bu nesne olmadan aşağıdaki fonksiyonlara erişemeyiz(databinding özelliği)
    ...
    fun topla(alinanSayi1:String, alinanSayi2:String){
        viewModel.topla(alinanSayi1,alinanSayi2) //işlem yapıyor
    }

    fun carp(alinanSayi1:String, alinanSayi2:String){
        viewModel.carp(alinanSayi1,alinanSayi2) //işlem yapıyor
    }
}